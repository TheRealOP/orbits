defmodule OrbitElixirWeb.DashboardLive do
  @moduledoc """
  Live observability dashboard for Orbit.
  """

  use Phoenix.LiveView, layout: {OrbitElixirWeb.Layouts, :app}

  alias OrbitElixirWeb.{Endpoint, ObservabilityPubSub, Presenter}
      ...
      <header class="hero-card">
        <div class="hero-grid">
          <div>
            ...
            <p class="hero-copy">
              Current state, retry pressure, token usage, and orchestration health for the active Orbit runtime.
            </p>
          </div>
  ...
  defp orchestrator do
    Endpoint.config(:orchestrator) || OrbitElixir.Orchestrator
  end
